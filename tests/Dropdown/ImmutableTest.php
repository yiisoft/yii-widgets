...
final class ImmutableTest extends TestCase
{
    ...
    public function testImmutable(): void
    {
        ...
        $this->assertNotSame($dropdown, $dropdown->containerTag('div'));
        ...
        $this->assertNotSame($dropdown, $dropdown->itemContainerTag('div'));
        $this->assertNotSame($dropdown, $dropdown->itemTag('div'));
        ...
        $this->assertNotSame($dropdown, $dropdown->itemsContainerTag('div'));
